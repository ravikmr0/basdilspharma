...
const contactSchema = {
  ...
  '@graph': [
    {
      '@type': 'ContactPage',
      '@id': 'https://www.basdilspharma.com/contact#webpage',
      'url': 'https://www.basdilspharma.com/contact',
      'name': 'Contact Us | Basdils Pharmaceuticals Pvt. Ltd.',
      'description': 'Get in touch with Basdils Pharmaceuticals for PCD Pharma Franchise, Third-Party Manufacturing, or distribution inquiries.',
      'isPartOf': { '@id': 'https://www.basdilspharma.com/#website' }
    },
    {
      '@type': 'BreadcrumbList',
      '@id': 'https://www.basdilspharma.com/contact#breadcrumb',
      'itemListElement': [
        {
          '@type': 'ListItem',
          'position': 1,
        ...
        },
        {
          ...
          'position': 2,
          'name': 'Contact',
          'item': 'https://www.basdilspharma.com/contact'
        }
      ]
    }
  ]
...
const departments = [
  {
    ...
    description: 'Strategic support for PCD franchise, distribution, pricing, and portfolio opportunities.',
    email: 'basdilpharma@gmail.com',
    icon: 'fa-chart-line'
  },
  {
    name: 'Third-Party Manufacturing',
    description: 'End-to-end manufacturing partnerships built around quality, precision, and scale.',
    email: 'basdilpharma@gmail.com',
    icon: 'fa-industry'
  },
  {
    name: 'Product Development',
    description: 'Bespoke formulations and nutraceutical solutions guided by scientific expertise.',
    email: 'info@basdilspharma.in',
    icon: 'fa-flask'
  },
  {
    name: 'Customer Support',
    description: 'Responsive assistance for product information, business inquiries, and ongoing support.',
    email: 'info@basdilspharma.in',
    icon: 'fa-headset'
  }
];
...
const offices = [
  {
    ...
    type: 'Head Office',
    address: 'Bagmali, Hajipur, Vaishali, Bihar - 844101, India',
    phone: '+91 9931691959',
    email: 'basdilpharma@gmail.com',
    hours: 'Monday - Friday: 9:00 AM - 6:00 PM',
    image: '/hero_section/manufacturing_process.png'
  },
  {
    name: 'Dehradun Office',
    type: 'Branch Office',
    address: 'Ekta Enclave, Kargi, Dehradun, Uttarakhand, India',
    phone: '+91 9931691959',
    email: 'info@basdilspharma.in',
    hours: 'Monday - Friday: 9:00 AM - 6:00 PM',
    image: '/hero_section/medical_excellence.png'
  }
];
...
export function ContactPage() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    const mailtoSubject = encodeURIComponent(`[Website Inquiry] ${subject || 'General Inquiry'}`);
    const mailtoBody = encodeURIComponent(
      `Name: ${name}\nCompany: ${company}\nEmail: ${email}\nPhone: ${phone}\n\nMessage:\n${message}`
    );

    window.location.href = `mailto:basdilpharma@gmail.com?subject=${mailtoSubject}&body=${mailtoBody}`;
  ...
  const contactMethods = [
    ...
    },
    {
      icon: 'fa-envelope',
      title: 'Email',
      value: 'basdilpharma@gmail.com',
      link: 'mailto:basdilpharma@gmail.com',
  ...
  return (
    <>
      <PageMeta
        title="Contact Us | PCD Franchise & Manufacturing Inquiry"
        description="Contact Basdils Pharmaceuticals Pvt. Ltd. for PCD pharma franchise, third-party manufacturing, or general business inquiries. Call +91 9931691959 or email basdilpharma@gmail.com."
        canonical="https://www.basdilspharma.com/contact"
      ...
      <section className="py-10 md:py-14 lg:py-16 bg-gradient-to-r from-primary-50 to-secondary-50">
        ...
        eyebrow="Get In Touch"
            title="Where Trusted Partnerships Begin"
            description="Connect with our team to explore pharmaceutical manufacturing, distribution, and product development opportunities shaped around your ambitions."
          />
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 card-base space-y-6">
              <div className="space-y-1">
                <h2 className="text-2xl md:text-3xl font-bold font-display text-gray-900">Start a Conversation</h2>
                <p className="text-base text-gray-600">Share your requirements with us, and our team will respond with thoughtful, confidential guidance.</p>
                {formSubmitted && (
                  <div className="p-4 bg-green-50 border border-green-200 text-green-800 rounded-lg text-sm font-medium">
                    ✓ Thank you! Opening your email client to send the message directly to basdilpharma@gmail.com.
                  </div>
                )}
              ...
              <aside className="space-y-5">
                ...
                <div className="card-base space-y-5 p-6">
                  <h3 className="text-base font-bold text-gray-900">At a Glance</h3>
                  <div className="space-y-3">
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-1 text-sm">Response Time</h4>
                      <p className="text-gray-600 text-xs">A member of our team typically responds within one business day.</p>
                    </div>
                    <div>
                ...
                <div className="card-base space-y-3 bg-white border-2 border-primary-200 p-6">
                  <h3 className="text-base font-bold text-gray-900">Priority Assistance</h3>
                  <p className="text-gray-700 text-xs">For time-sensitive requirements, speak directly with our team by phone or WhatsApp.</p>
      ...
      <section className="py-10 md:py-14 lg:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold font-display text-gray-900 mb-2">Specialist Teams, Personal Attention</h2>
            <p className="text-base text-gray-600">Connect directly with the experts best suited to your requirements.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <section className="py-10 md:py-14 lg:py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold font-display text-gray-900 mb-2">Our Presence</h2>
            <p className="text-base text-gray-600">Meet with our team at one of our offices in India.</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto space-y-6">
            <div className="space-y-2">
              <h2 className="text-3xl md:text-4xl font-bold font-display text-white">Build What Comes Next with BASDILS</h2>
              <p className="text-base text-primary-100">From PCD franchise opportunities to third-party manufacturing and bespoke formulations, discover a partnership designed for enduring growth.</p>
            </div>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a href="mailto:basdilpharma@gmail.com" className="px-8 py-4 bg-white text-primary-600 font-semibold rounded-lg hover:bg-gray-100 transition-all duration-300 shadow-lg hover:shadow-xl inline-block">
                <i className="fa-solid fa-paper-plane mr-2" /> Begin a Conversation
              </a>
              <a href="tel:+919931691959" className="px-8 py-4 bg-primary-800 hover:bg-primary-900 text-white font-semibold rounded-lg transition-all duration-300 border-2 border-white/30 inline-block">
                <i className="fa-solid fa-phone mr-2" /> Speak with Our Team
              </a>
            </div>
          </div>
        </div>
