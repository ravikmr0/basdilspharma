    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
            <div className="text-center animate-fade-in" style={{ animationDelay: '0.1s' }}>
              <div className="text-5xl font-bold font-display text-primary-600 mb-1">15+</div>
              <p className="text-gray-600 font-medium text-sm">Years of Excellence</p>
            </div>
            <div className="text-center animate-fade-in" style={{ animationDelay: '0.2s' }}>
              <div className="text-5xl font-bold font-display text-primary-600 mb-1">100+</div>
              <p className="text-gray-600 font-medium text-sm">Premium Products</p>
            </div>
            <div className="text-center animate-fade-in" style={{ animationDelay: '0.3s' }}>
              <div className="text-5xl font-bold font-display text-primary-600 mb-1">500+</div>
              <p className="text-gray-600 font-medium text-sm">Healthcare Partners</p>
            </div>
            <div className="text-center animate-fade-in" style={{ animationDelay: '0.4s' }}>
              <div className="text-5xl font-bold font-display text-primary-600 mb-1">98%</div>
      ...
      <section className="py-10 md:py-14 lg:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            <article className="p-6 rounded-2xl bg-white border-l-4 border-primary-600 hover:shadow-lg transition-all duration-300">
            ...
            <article className="p-6 rounded-2xl bg-white border-l-4 border-purple-600 hover:shadow-lg transition-all duration-300">
            ...
            <article className="p-6 rounded-2xl bg-white border-l-4 border-yellow-600 hover:shadow-lg transition-all duration-300">
      ...
      <section className="py-10 md:py-14 lg:py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          />
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
            <div className="p-6 bg-white rounded-xl border border-gray-200 hover:shadow-lg transition-all duration-300 animate-fade-in space-y-2" style={{ animationDelay: '0.1s' }}>
            ...
            <div className="p-6 bg-white rounded-xl border border-gray-200 hover:shadow-lg transition-all duration-300 animate-fade-in space-y-2" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="p-6 bg-white rounded-xl border border-gray-200 hover:shadow-lg transition-all duration-300 animate-fade-in space-y-2" style={{ animationDelay: '0.3s' }}>
            ...
            <div className="p-6 bg-white rounded-xl border border-gray-200 hover:shadow-lg transition-all duration-300 animate-fade-in space-y-2" style={{ animationDelay: '0.4s' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
            {[
              ...
              <article key={idx} className="p-6 bg-white rounded-xl border border-gray-200 hover:shadow-lg hover:border-primary-200 transition-all duration-300 animate-fade-in space-y-2" style={{ animationDelay: `${0.1 * (idx + 1)}s` }}>
